...
def main(args):
    ...
    teacher_transformer.to(accelerator.devie,dtype=weight_dtype)
    ...
    adaweighter_parameters_with_lr =   {"params": adaweighter.parameters(), "lr": args.learning_rate}
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(models_to_accumulate):
                ...
                # sample z
                z = torch.randn_like(batch)*args.sigma_data
                tau = torch.randn(batch.shape[0])*args.P_std + args.P_mean
