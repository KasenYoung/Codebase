...
# pip install decord tiktoken peft ipdb
# huggingface-cli download --local-dir-use-symlinks False THUDM/CogVideoX-2b --local-dir  CogVideoX-2b

export CACHE_PATH=".cache"
export DATASET_PATH="subset-video/video"
