...
def download_files(output_directory):
    ...
    '''
    for i in range(0,1):
        url = f"https://hf-mirror.com/datasets/nkp37/OpenVid-1M/resolve/main/OpenVid_part{i}.zip"
        ...
        try:
            ...
            part_urls = [
                f"https://hf-mirror.com/datasets/nkp37/OpenVid-1M/resolve/main/OpenVid_part{i}_partaa",
                f"https://hf-mirror.com/datasets/nkp37/OpenVid-1M/resolve/main/OpenVid_part{i}_partab"
            ]
            ...
            subprocess.run(unzip_command, check=True)
    '''
    data_folder = os.path.join(output_directory, "captions")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_directory', type=str, help='Path to the dataset directory', default="subset-video")
